...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(driveController, ControllerButtons.fire).whenPressed(new FireCheck(m_Indexer, m_Collector, m_Mills, m_Shooter));
    ...
    new JoystickButton(driveController, ControllerButtons.adjust).whileHeld(new AutoAdjust(m_Adjuster, m_Limelight));
